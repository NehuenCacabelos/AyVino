...
Este documento detalla el mapa de navegación, los flujos de usuario y la estrategia de integración frontend para la plataforma **AyVino**, alineado estrictamente con los requisitos funcionales de [`docs/spec.md`](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md).
...
| `/bodegas/:id` | `WineryProfilePage.tsx` | Público / Abierto | Perfil de bodega con distinción entre bodega oficial verificada y bodega creada por comunidad ([RF-1.4](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md)). |
| `/subir-vino` | `AddWinePage.tsx` | Requiere Auth | Carga comunitaria de vinos nuevos por foto o ingreso manual ([RF-1.2](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md), [RF-1.6](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md)). |
| `/mis-colecciones`| `MyCellarPage.tsx` | Requiere Auth | Panel personal del usuario con sus listas fijas: **"Favoritos"** y **"Por Probar"** ([RF-3.1](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md)). |
...
### Flujo B: Exploración y Ficha de Cata ([RF-1.3](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md), [RF-2.1](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md), [RF-2.2](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md))
- **Descubrimiento**:
...
- **Interacciones en Ficha**:
  - **Me Gusta / Like**: Toggle rápido ([RF-2.2](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md)).
  - **Guardar en Colección**: Selector desplegable para asignar a *"Favoritos"* o *"Por Probar"* ([RF-3.1](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md)).
  - **Escribir Reseña**: Calificación de 1 a 5 estrellas + reseña escrita en texto libre ([RF-2.1](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md)).

---

### Flujo C: Carga Comunitaria de Vinos ([RF-1.2](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md), [RF-1.6](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md))
...
3. **Formulario y Validación**:
   - **Obligatorios**: Nombre del vino y Bodega ([RF-1.6](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md) - feedback inmediato si faltan).
...
### Flujo D: Gestión de Colecciones Fijas ([RF-3.1](file:///c:/Codigo%20General/AyVino/AyVino/docs/spec.md))
